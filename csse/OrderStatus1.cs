...
namespace csse
{
    public partial class OrderStatus1 : Form
    {
        public OrderStatus1()
        {
            InitializeComponent();
        ...
        public void displayDetails()
        {
            ...
            dataGridView1.Rows[0].Cells[4].Value = "Approved";
            ...
            dataGridView1.Rows[2].Cells[4].Value = "Approved";
            ...
            dataGridView1.Rows[3].Cells[4].Value = "Declined";
            ...
            dataGridView1.Rows[6].Cells[4].Value = "Approved";
        }
    }
}
